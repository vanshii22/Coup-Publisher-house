...
<section class="session_program py-5">
    <div class="container">
        ...
        <div class="row card_wrapper py-3">
            <div class="col-lg-4 col-md-6 card p-5 px-1">
                <div class="card-body text-center">
                    <div class="card-title  pb-3">
                        <p>Career Counselling</p>
                    </div>
                    <a href="contact-us.php">@79* Per Student</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 card p-5 px-1">
                <div class="card-body text-center">
                    ...
                    <a href="contact-us.php">@49* Per Student</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 card p-5 px-1">
                <div class="card-body text-center">
                    <div class="card-title  pb-3">
                        <p>Teacher's Training Program</p>
                    </div>
                    <a href="contact-us.php">@299* Per Teacher</a>
                </div>
            </div>
        </div>
        <div class="row btn-part flex-d text-center">
            <p><b>For more Details </b>
            <p>
                <a href="tel:+918267992305" class="btn btn-main call_btn"> Call : 8267-9923-05</a>
