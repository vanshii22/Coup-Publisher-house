                          ...
                          <div class="col-lg-8 col-sm-12 col-md-6">
                              <div class="main-banner-content">
                                  ...
                                  <div class="btn-container">
                                      <a href="#" target="_blank" class="btn btn-main"> Learn More</a>
                                      <a href="#" target="_blank" class="btn btn-main-2 ml-0 ml-lg-2 ">Get It Now</a>
                                  </div>
                              </div>
                          </div>
  ...
  <div id="card-section" class="container">
      <div class="card" style="width: 25rem;">
          ...
          <div class="card-body">
              ...
              <p class="card-text">From classic literature to cutting-edge non-fiction, our extensive catalog offers
      ...
      <div class="card" style="width: 25rem;">
          ...
          <div class="card-body">
              ...
              <p class="card-text">Be the first to get your hands on new releases with our exclusive pre-order options.
              </p>
          </div>
      ...
      <div class="card" style="width: 25rem;">
          ...
          <div class="card-body">
              ...
              <p class="card-text">Get to know the brilliant minds behind your favorite books with exclusive interviews
                  and features.</p>
          </div>
